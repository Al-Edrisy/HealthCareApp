...
import { createUserWithEmailAndPassword, googleSignIn, auth } from '../constants/FireBaseConfig'; // Ensure this import is correct
...
const CreateAccount = ({ navigation }) => {
    ...
    const handleCreateAccount = async () => {
        if (validateFields()) {
          ...
          setErrors({});
          try {
            await createUserWithEmailAndPassword(auth, email, password); // Ensure this method exists and works
